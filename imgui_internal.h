...
//#endif
    ...
    IMGUI_API bool          Keybind1(const char* label, int* key);
    IMGUI_API bool          NotifyEx(const char* zagolovok, const char* osn_text, const ImVec2& size_arg, const ImVec2& position, const ImVec4& col, bool activate, float pos_0, float pos_1, ImGuiButtonFlags flags);
    IMGUI_API bool          Notify(const char* zagolovok, const char* osn_text, const ImVec2& size_arg = ImVec2(0, 0), const ImVec2& position = ImVec2(0, 0), const ImVec4& col = ImColor(0, 0, 0, 0), bool activate = false, float pos_0 = 0.0f, float pos_1 = 0.0f);
    IMGUI_API void          TextEx(const char* text, const char* text_end = NULL, ImGuiTextFlags flags = 0);
    IMGUI_API bool          ButtonEx(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          CButtonEx(const char* ico0, const char* label, bool bg, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          TabEx(const char* ico0, const char* label, bool selected, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    ...
    IMGUI_API bool          InputTextExCenterAligned(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback = NULL, void* callback_user_data = NULL);
    IMGUI_API bool          TempInputText(const ImRect& bb, ImGuiID id, const char* label, char* buf, int buf_size, ImGuiInputTextFlags flags);
    IMGUI_API bool          TempInputTextCenterAligned(const ImRect& bb, ImGuiID id, const char* label, char* buf, int buf_size, ImGuiInputTextFlags flags);
    IMGUI_API bool          TempInputScalar(const ImRect& bb, ImGuiID id, const char* label, ImGuiDataType data_type, void* p_data, const char* format, const void* p_clamp_min = NULL, const void* p_clamp_max = NULL);
    IMGUI_API bool          TempInputScalarCenterAligned(const ImRect& bb, ImGuiID id, const char* label, ImGuiDataType data_type, void* p_data, const char* format, const void* p_clamp_min = NULL, const void* p_clamp_max = NULL);
