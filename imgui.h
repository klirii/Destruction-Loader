...
namespace ImGui
{
    ...
    IMGUI_API void          BeginGroupPos(const ImVec2& pos);
    IMGUI_API void          EndGroupPos();
    ...
    IMGUI_API bool          CheckboxWithCustomLabelID(const char* label_id, const char* label, bool* v);
    ...
    IMGUI_API bool          SliderIntRange(const char* label, int* v, int v_min, int v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API bool          ColorPicker3f(float col[3]);
    IMGUI_API bool          ColorPicker4f(float col[4]);
